<template>
  <div>
    <v-hover v-slot="{ isHovering, props }">
      <v-card class="mx-auto" color="" max-width="600" v-bind="props">
        <v-img
          :aspect-ratio="16 / 9"
        ...
        <v-card-text class="pt-6">
          ...
          <h3 class="text-h4 font-weight-light mb-2">QW cooking utensils</h3>
...
<script>
import { VCard, VCardText, VHover, VImg, VExpandTransition } from 'vuetify/lib/components/index.mjs'
